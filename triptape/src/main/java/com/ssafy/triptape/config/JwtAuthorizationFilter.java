...
import com.ssafy.triptape.common.util.AutoConstants;
import com.ssafy.triptape.common.util.TokenUtil;
import com.ssafy.triptape.config.exception.BusinessExceptionHandler;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain chain)
        ...
        String header = request.getHeader(AutoConstants.AUTH_HEADER);
